...
var _share = _interopRequireDefault(__webpack_require__(/*! utils/share.js */ 41));



var _islogin = _interopRequireDefault(__webpack_require__(/*! utils/islogin.js */ 42));



var _api = _interopRequireDefault(__webpack_require__(/*! utils/api */ 43));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}wx.__webpack_require_UNI_MP_PLUGIN__ = __webpack_require__;_vue.default.config.productionTip = false;_App.default.mpType = 'app';_vue.default.use(_uviewUi.default);_vue.default.mixin(_share.default);_vue.default.prototype.$login = _islogin.default;
_vue.default.prototype.$api = _api.default;


_vue.default.prototype.$imgPath = "https://bao.scwushen.com";


_vue.default.prototype.$shangchuan = "http://bao.scwushen.com/index.php";


_vue.default.prototype.$imgs = function (url) {
  if (url == "" || url == null) {
    return url;
  }
...
_vue.default.prototype.$shangchuan = "https://bao.scwushen.com/index.php";
...
{
  onLaunch: function onLaunch(ev) {var _this = this;
  ...
  onShow: function onShow(ev) {var _this2 = this;
    if (ev.query.uid) {
      uni.setStorageSync("yaoqinguid", ev.query.uid);
      if (uni.getStorageSync("user_info")) {
        this.$api.ewmjoin({
    ...
    this.$api.agreements().then(function (data) {
      if (data.data.code == 1) {
        data.data.data.status.forEach(function (item) {
          item["check"] = false;
        });
        ...
        then(function (data) {
          if (data.data.code == 1) {
            if (uni.getStorageSync("yanzheng")) {
              ...
              _this2.$api.agreements().then(function (datas) {
                if (datas.data.code == 1) {
                  datas.data.data.status.forEach(function (item) {
                    item["check"] = false;
                  });
